package com.sistemas.facturacion.service.impl;// El Departamento de Seguridad Informatica de la AFIP (DeSeIn/AFIP), pone a disposicion
...
public class wsaa_test {
	...
	public static void main(String [] args ) {
		...
		String endpoint = "http://wsaahomo.afip.gov.ar/ws/services/LoginCms";
		String service = "test";
		String dstDN = "cn=wsaahomo,o=afip,c=ar,serialNumber=CUIT 33693450239";
		
		String p12file = "test-keystore.p12";
		String signer = "coqui";
		String p12pass = "miclaveprivada";
